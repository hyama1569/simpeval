...
if __name__ == '__main__':
    ...
    newsela_3more_75 = data[data['comp_simp_diff'] >= 3].sample(n=int(3*len(data[data['comp_simp_diff'] >= 3])/4), random_state=0)
    newsela_3more_50 = newsela_3more_75.sample(n=int(2*len(newsela_3more_75)/3), random_state=0)
    newsela_3more_25 = newsela_3more_50.sample(n=int(len(newsela_3more_50)/2), random_state=0)
